...
public interface ConcertService {
	...
	/**
	 * Subscribes for news notifications.
	 * 
	 * @throws ServiceException in response to any of the following conditions.
	 * The exception's message is defined in 
	 * class nz.ac.auckland.concert.common.Messages.
	 ...
	 * 
	 */
	void subscribeToNews() throws ServiceException;
	
	/**
	 * Unsubscribes from news notifications.
	 * 
	 * @throws ServiceException in response to any of the following conditions.
	 * The exception's message is defined in 
	 * class nz.ac.auckland.concert.common.Messages.
	 ...
	 * 
	 */
	void unsubscribeToNews() throws ServiceException;
	
	/**
	 * Interface to listen to incoming news notifications. A NewsListener is expected 
	 * to process the incoming news.
	 *
	 */
	interface NewsListener {
		void newsReceived(NewsDTO news);
	}
}
